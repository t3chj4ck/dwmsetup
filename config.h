...
static const char col_bg[] = "#ff4722";
...
static const char *dmenucmd[] = {
    ...
    col_gray3,   "-sb", col_bg, "-sf", col_gray4, NULL};
static const char *rofimenu[] = {
	"rofi", "-show", "run", NULL
};
static const char *termcmd[] = {"kitty", NULL};
static const char *screenst[] = { "sh", "-c", "maim -s | xclip -selection clipboard -t image/png", NULL };
